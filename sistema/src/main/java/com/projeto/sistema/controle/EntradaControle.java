...
public class EntradaControle {
	...
	public ModelAndView cadastrar(Entrada entrada, ItemEntrada itemEntrada, BindingResult result) {
	...
	public ModelAndView removerItem(@PathVariable("id") Long id, Entrada entrada) {
		...
		return cadastrar(entrada, new ItemEntrada(), null);
	...
	public ModelAndView salvar(String acao, Entrada entrada, ItemEntrada itemEntrada, BindingResult result) {
	    if (result.hasErrors()) {
	        return cadastrar(entrada, itemEntrada, result);
	    }
	    ...
	    if (acao.equals("itens")) {
	        ...
	        this.listaItemEntrada = new ArrayList<ItemEntrada>();
	        return cadastrar(new Entrada(), new ItemEntrada(), result);
	    }
